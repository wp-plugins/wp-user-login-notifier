...
= How to turnoff some of the notification emails? =

Please visit your WordPress dashboard->settings->WP User Login Notifier and update the settings. You can turn on/off individual email notifications.

= Is this plugin compatible with Multisite? =

Yes if you activate on individual sites, do not network activate it.
...
2. Failed Login Notification to the user screenshot-2.png
3. Successful Login notification to admin screenshot-3.png
4. Successful Login Notification to the user screenshot-4.png
5. Configuration settings screenshot-5.png
